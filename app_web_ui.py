# Form implementation generated from reading ui file '.\app_web_ui.ui'
#
...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.startBtn.setGeometry(QtCore.QRect(210, 30, 110, 45))
        self.startBtn.setObjectName("startBtn")
        self.selectallBtn = QtWidgets.QPushButton(parent=self.centralwidget)
        self.selectallBtn.setGeometry(QtCore.QRect(40, 30, 110, 45))
        ...
        self.refreshBtn.setGeometry(QtCore.QRect(380, 30, 110, 45))
    ...
    def retranslateUi(self, mainWindow):
        ...
        mainWindow.setWindowTitle(_translate("mainWindow", "App Web Check List "))
