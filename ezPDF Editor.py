...
def ezPDF_Editor(app_name, file_name_exe, download_link):
    app_name = 'ezPDF Editor'
    try:
...
#     download_link = 'https://www.unidocs.co.kr/data/ezpdfeditor/personal/ezPDFEditor_Personal_Setup_3.0.8.4.exe'
#     ezpdf_editor(app_name, 'ezPDFEditor_Personal_Setup_3.0.8.4.exe', download_link)
