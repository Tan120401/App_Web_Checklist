...
def Anaconda(app_name, file_name_exe, download_link):
    app_name = 'Anaconda'
    try:
...
#     download_link = 'https://repo.anaconda.com/archive/Anaconda3-2024.10-1-Windows-x86_64.exe'
#     ANACONDA(app_name, '', download_link)
