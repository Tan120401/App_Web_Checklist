...
def FileZilla(app_name, file_name_exe, download_link):
    app_name = 'FileZilla'
    try:
...
#     download_link = 'https://download.filezilla-project.org/client/FileZilla_3.68.1_win64_sponsored2-setup.exe'
#     FileZilla(app_name, '', download_link)
