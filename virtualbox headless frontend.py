...
#
app_name = 'Oracle VirtualBox'


def virtualbox_headless_frontend(app_name, file_name_exe, download_link):
    app_name = 'Oracle VirtualBox'
    try:
...
#     download_link = 'https://download.virtualbox.org/virtualbox/7.1.6/VirtualBox-7.1.6-167084-Win.exe'
#     virtualbox_headless_frontend(app_name, '', download_link)
