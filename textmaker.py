...
def textmaker(app_name, file_name_exe, download_link):
    app_name = 'SoftMaker'
    try:
...
#     download_link = 'https://www.softmaker.net/down/softmaker-office-nx-64.msi'
#     textmaker(app_name, 'LibreOffice_25.2.1_Win_x86-64.msi', download_link)
