...
def Korean_Investment_HTS(app_name, file_name_exe, download_link):
    app_name = 'Plus'
    try:
...
#     download_link = 'https://new.real.download.dws.co.kr/download/eFriendPlus_setup.exe'
#     Korean_Investment_HTS(app_name, '', download_link)
