...
def nPDF(app_name, file_name_exe, download_link):
    app_name = 'nPDF'
    try:
...
#     download_link = 'https://github.com/jjkapp/jjkapp.github.io/raw/master/npdf/nPDF_0.9.3.1_(32%2C64bit).exe'
#     nPDF(app_name, '', download_link)
