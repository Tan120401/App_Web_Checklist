...
def  MEMU_PLAY(app_name, file_name_exe, download_link):
    app_name = 'MEMU PLAY'
    try:
        ...
        sleep(10)
        install_btn_path = os.path.join('res', 'menuplay_quickinstall.png')
...
if __name__ == '__main__':
    download_link = 'https://www.memuplay.com/download-memu-on-pc.html?from=offline_installer_web'
    MEMU_PLAY(app_name, '', download_link)
