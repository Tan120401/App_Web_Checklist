...
def ipTIME(app_name, file_name_exe, download_link):
    app_name = 'ipTIME'
    try:
...
if __name__ == '__main__':
    download_link = 'http://download.iptime.co.kr/online_upgrade/ipTIME_Upgrade_Noti_Setup_1.36.exe'
    ipTIME(app_name, '', download_link)
