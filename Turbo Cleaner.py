...
#
app_name = 'TurboCleaner'


def Turbo_Cleaner(app_name, file_name_exe, download_link):
    app_name = 'TurboCleaner'
    try:
...
#     download_link = 'http://up1.turbovaccine.com/Download/TurboCleaner/TurboCleanerSetup.exe'
#     Turbo_cleaner(app_name, '', download_link)
