...
app_name = 'Double Commander'

def Double_Commander(app_name, file_name_exe, download_link):
    app_name = 'Double Commander'
    try:
        ...
        if '.exe' in install_files[0]:
            install_command = f'"{install_path}" /VERYSILENT /SUPPRESSMSGBOXES /NORESTART /SP-'
        else:
            install_command = [
                "msiexec",
...
#     download_link = 'https://sourceforge.net/projects/doublecmd/files/latest/download'
#     Double_Commander(app_name, '', download_link)
