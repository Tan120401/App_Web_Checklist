...
def Goclean(app_name, file_name_exe, download_link):
    try:
        ...
        print(f'error app: {e}')
        return False
result = Goclean('Goclean','thiết_lập_Avast_Free_Antivirus_trực_tuyến.exe','https://www.avast.com/vi-vn/download-thank-you.php?product=FAV-ONLINE-HP&locale=vi-vn&direct=1')
print(result)
'https://www.turbovaccine.com/TVIS_R3_M.exe'