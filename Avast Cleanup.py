...
def Avast_Cleanup(app_name, file_name_exe, download_link):
    app_name = 'Avast'
    try:
        ...
        sleep(10)
        # print('toi day khong')
        install_btn_path = os.path.join('res', 'avast_install_button.png')
        ...
        for i in range(60):
            ...
            if result:
                ...
                for i, win in enumerate(windows):
                    ...
                    if 'Avast Free Antivirus' in win.window_text():
                        win.close()
                        sleep(2)
                return True
            sleep(5)
...
#     download_link = 'https://www.avast.com/download-thank-you.php?product=FAV-ONLINE-STORE&amp;locale=en-ww&amp;direct=1'
#     Avast_Cleanup(app_name, '', download_link)
