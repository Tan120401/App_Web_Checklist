...
def OpenOffice(app_name, file_name_exe, download_link):
    app_name = 'OpenOffice'
    try:
...
#     download_link = 'https://sourceforge.net/projects/openofficeorg.mirror/files/latest/download'
#     OpenOffice(app_name, '', download_link)
