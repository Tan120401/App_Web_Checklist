...
def Notion(app_name, file_name_exe, download_link):
    app_name = 'Notion'
    try:
...
#     download_link = 'https://www.notion.com/desktop/windows-arm/download?from=marketing&pathname=%2Fko%2Fdownload&tid=8ada6209fc324f9a95d58a30115fe3a5'
#     NOTION(app_name, 'Notion Setup 4.6.0 arm64.exe', download_link)
