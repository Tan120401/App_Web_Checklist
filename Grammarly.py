...
def Grammarly(app_name, file_name_exe, download_link):
    app_name = 'Grammarly'
    try:
...
#     download_link = 'https://download-windows.grammarly.com/w/GrammarlyInstaller.exe?browserName=microsoft%20edge&amp;containerId=olgk9mcgh5n40202&amp;state=gTOAm&amp;_gl=1*19n9kc9*_gcl_au*MTMwOTMzNDA5Ni4xNzQxNzYxOTYw'
#     Grammarly_for_Your_Desktop(app_name, '', download_link)
